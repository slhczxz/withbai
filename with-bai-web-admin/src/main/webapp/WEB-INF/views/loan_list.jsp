                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">贷款订单</h3>
                        </div>

                        <div class="row">
                            <div class="col-sm-12" style="padding-left: 25px">
                                <a type="button" onclick="approvalItems()" class="btn btn-sm btn-default"><i
                                        class="fa  fa-edit"></i> 批量审批</a>&nbsp;&nbsp;
...
<script>
    ...
    function  approvalItems() {
        ...
        if (_idArray.length == 0) {//弹出莫泰框
            ...
            $.ajax({
                "url": "${pageContext.request.contextPath}/loan/approvemulti",
                "type": "GET",
    ...
    var oTable = $("#datatable").DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": "${pageContext.request.contextPath}/loan/page",
        },
        "columns": [
            {
                "data": function (row, type, val, meta) {
                    return '<input id="' + row.oid + '" type="checkbox" class="minimal">';
                }
            },
            {"data":"oid"},
            {"data":"user.name"},
