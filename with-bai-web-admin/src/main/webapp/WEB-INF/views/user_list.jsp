                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <div class="col-sm-12" style="padding-left: 25px">
                                ...
                                <a type="button" onclick="deleteItems()" class="btn btn-sm btn-default"><i
                        ...
                        <div class="box-body" style="padding-bottom: 0px;padding-top: 30px;">
                            <div class="col-sm-3 form-group">
                                <label for="name" class="col-sm-3 control-label" style="line-height: 34px;heigth:34px">姓名</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" placeholder="用户名"/>
                                </div>
                            </div>
                            <div class="col-sm-3 form-group">
                                <label for="phone" class="col-sm-3 control-label" style="line-height: 34px;heigth:34px">电话</label>
                                <div class="col-sm-9">
                                    <input type="text" id="phone" class="form-control" placeholder="电话">
                                </div>
                            </div>
                            <div class="col-sm-3 form-group">
                                <label for="email" class="col-sm-3 control-label" style="line-height: 34px;heigth:34px">邮箱</label>
                                <div class="col-sm-9">
...
<script>
    ...
    function btnModalClick(value) {
        ...
        //ajax
        $.ajax({
            "url": "${pageContext.request.contextPath}/user/deletemulti",
            "type": "GET",
            "data": {"uids":value/*_idArray.toString()*/},
            "dataType": "JSON",
    ...
    var oTable = $("#datatable").DataTable({
        ...
        "columns": [
            ...
            {"data":function(row, type, val, meta){
             ...
             {
                 "data": function (row, type, val, meta) {
                     return '<a type="button" class="btn btn-sm btn-default" onclick="show('+row.uid+')"><i class="fa fa-search"></i>查看</a>&nbsp;&nbsp;'+
                     '<a type="button" class="btn btn-sm btn-primary" href="${pageContext.request.contextPath}/user/form?uid='+row.uid+'"><i class="fa fa-edit"></i>编辑</a>&nbsp;&nbsp;'+
                     '<a type="button" class="btn btn-sm btn-danger"  onclick="deletebyId('+row.uid+')"><i class="fa fa-trash"></i>删除</a>&nbsp;&nbsp;';
