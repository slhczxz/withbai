                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"> 新建下一级分类</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <%--<form class="form-horizontal" action="/user/save" method="post">--%>
                        <form:form cssClass="form-horizontal" action="${pageContext.request.contextPath}/content/category/save" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" class="form-control" readonly="true"
                                               id="parentName" value="${category.parent.name}" />
...
<script>
    ...
    var setting = {
        ...
        async: {
            enable: true,
            url: "${pageContext.request.contextPath}/content/category/detail",
