...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/assets/plugins/jquery-ztree/css/zTreeStyle/zTreeStyle.css"/>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        ...
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/expert/save" method="post">
                            <div class="box-body">

                                <div class="form-group">
                                    <label for="name" class="col-sm-2 control-label">专家名称</label>

                                    <div class="col-sm-10">

                                        <input class="form-control" id="name" name="name" placeholder="专家名称"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <textarea cols="20px" class="form-control" id="detail" name="detail" placeholder="详情"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="hidden" class="form-control" id="image" name="image" placeholder="上传图片" />
