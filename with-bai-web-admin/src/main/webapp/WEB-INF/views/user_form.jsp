    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>用户管理</li>
                <li class="active">${tbUser.uid==null?"新增":"编辑"}用户</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"> ${tbUser.uid==null?"新增":"编辑"}用户</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <form:input cssClass="form-control" path="IDNumber" placeholder="身份证"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                            <%-- <input type="text" class="form-control" value="${tbUser.username}" name="username" id="username" placeholder="姓名">--%>
                                        <form:input cssClass="form-control" path="name" placeholder="姓名"/>
                                    </div>
                                </div>
                                <c:if test="${tbUser.uid==null}">
                                    <div class="form-group">
